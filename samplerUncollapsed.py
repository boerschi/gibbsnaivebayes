"""
  ...
  this sampler differs from the one they describe only in that it allows for multiple classes
...
def probLabel(x,i):
    """predictive probability for label x, excluding the count for document i"""
    global gammaPi
